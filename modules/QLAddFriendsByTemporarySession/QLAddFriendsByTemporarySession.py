...
class QLAddFriendsByTemporarySession:
    ...
    def action(self, d, z,args):
        ...
        while i < 200:
            ...
            if 'icmp_seq' and 'bytes from' and 'time' in ping[0]:
                z.toast( "网络通畅。开始执行：QQ轻聊版临时会话加好友" )
                break
            z.sleep( 2 )
        if i > 200:
...
def getPluginClass():
    return QLAddFriendsByTemporarySession
...
if __name__ == "__main__":
    ...
    args = {"repo_number_cate_id": "119", "repo_material_cate_id": "39", "add_count": "5","time_delay": "3"}
    o.action(d, z,args)