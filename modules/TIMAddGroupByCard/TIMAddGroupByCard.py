...
if __name__ == "__main__":
    ...
    args = {"repo_number_id":"229","repo_material_id":"140","totalNumber":"10","time_delay":"3","switch":"否"}    #cate_id是仓库号，length是数量
    o.action(d, z,args)
