...
class TIMAddFriendByShareCard2:
    def __init__(self):
        self.repo = Repo()
    ...
    def action(self, d,z,args):
        ...
        while True:            #总人数
            ...
            if d(text="申请加群").exists:
                continue
            objtext = d(index=0,className="android.widget.LinearLayout").child(index=1,className="android.widget.RelativeLayout").child(index=1,className="android.widget.TextView")
            if objtext.exists:
...
if __name__ == "__main__":
    ...
    args = {"repo_number_cate_id":"119","repo_material_cate_id":"39",'gender':"男","add_count":"3","time_delay":"3","switch_card":"否","switch":"否"}    #cate_id是仓库号，length是数量
    try:
        o.action( d, z, args )
    except :
       z.toast("模块异常")
