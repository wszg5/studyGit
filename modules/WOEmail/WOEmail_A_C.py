...
class WOEmail_A_C:
    ...
    def send(self,message,my_sender,password,my_user,theme,bcc,name,imgpath):
        ret = True
        try:
            my_user = ["2578374050@qq.com"]
            # bcc = bcc + ['2351382894@qq.com']     #测试用的
    ...
    def getImg(self,html):
        ...
        if not os.path.exists( '/home/zunyun/text/img' ):
            os.mkdir( "/home/zunyun/text/img" )
        # if not os.path.exists( '/home/zunyun/text/img/%s'%imgName ):
        g = os.walk( "/home/zunyun/text/img" )
    ...
    def sendProcess(self, args):
        try:
            ...
            while True:
                ...
                numbers = self.repo.GetAccount("normal",repo_account_cate_id, 0, 1 )
                if len( numbers ) == 0:
