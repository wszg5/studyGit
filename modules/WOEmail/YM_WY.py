            ...
            while True:
                ...
                while flag:
                    ...
                    if selectContent2 == "只发内容":
                        ...
                        emailnumberObj.click()
                        emailnumberObj.send_keys( Keys.TAB, Keys.CONTROL, 'a', Keys.CONTROL, Keys.CONTROL, 'v' )
                        time.sleep(1)
                        # emailnumberObj.click()
                        # emailnumberObj.click( )
                        # emailnumberObj.send_keys( Keys.TAB, Keys.TAB, Keys.TAB, Keys.TAB, Keys.TAB, Keys.TAB, Keys.TAB,
                ...
                for floder in floders:
                    ...
                    while True:
                        try:
                            ...
                            try:
                                driver.find_element_by_xpath(
                                    '//*[@id="oFormMessage"]/div/div/div[2]/input[1]' ).send_keys( Keys.ENTER,
                                                                                                   Keys.ENTER )
                            except:
                                pass
