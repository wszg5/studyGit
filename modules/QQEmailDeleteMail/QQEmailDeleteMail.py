...
if __name__ == "__main__":
    ...
    #     da = (f.read())
    #     print(da)
    # url = "http://162626i1w0.51mypc.cn:10025/ocr.index"
    # r = requests.post(url, timeout=30, data={"img":da})
    # print(r.status_code)
    # print(r.url)
    # print(r.text)