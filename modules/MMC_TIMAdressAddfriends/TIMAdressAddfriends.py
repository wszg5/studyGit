...
class TIMAdressAddfriends:
    ...
    def Bind(self, d, z):
        ...
        while newStart == 1:
            ...
            print(GetBindNumber)
            if isinstance(GetBindNumber,list) and len(GetBindNumber)>0:
...
if __name__ == "__main__":
    ...
    args = {"repo_cate_id":"113",'number_count':'50',"random_name":"是","clear":"是","time_delay":"3","repo_material_id":"52","switch_card":"否",
