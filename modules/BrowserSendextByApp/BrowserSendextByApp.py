...
class TIMBrowserSendText:
    ...
    def action(self, d, z, args):
        ...
        while wait == 1:
            ...
            if "Error" in numbers:  # 没有取到号码的时候
                d.server.adb.cmd("shell",
                                 "am broadcast -a com.zunyun.qk.toast --es msg \"QQ号码%s号仓库为空，等待中\"" % cate_id).communicate()
                time.sleep(20)
                continue
            elif lenth == 0:
                d.server.adb.cmd("shell",
        ...
        d.server.adb.cmd("shell", "am start -n com.kingkr.kptjdlp/com.kingkr.webapp.activity.MainActivityFixup").communicate()  # 拉起来
        time.sleep(3)
...
if __name__ == "__main__":
    ...
    args = {"repo_number_cate_id": "37", "repo_material_cate_id": "34", "totalNumber": "4",
