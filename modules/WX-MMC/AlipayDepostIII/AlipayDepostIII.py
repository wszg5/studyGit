...
if __name__ == "__main__":
    ...
    args = {'run_time_min': '1', 'run_time_max': '3', 'start_time': '', 'stop_time': '', "repo_information_id":"219","contact_wait":"10","repo_cate_id":"264",'number_count':'50',"random_name":"是","clear":"是", "intervalTime": "120","time_delay": "3"};    #cate_id是仓库号，length是数量

    o.action(d, z,args)
    # page = urllib2.urlopen( 'https://rc.mbd.baidu.com', timeout=10 )
    # data = page.read( )
    # print data
