...
class MobilqqAddressList:
    ...
    def Bind(self,d):
        d.server.adb.cmd("shell", "am force-stop io.dcloud.H59ABC8B4").wait()  # 强制停止
        d.server.adb.cmd("shell", "am start -n io.dcloud.H59ABC8B4/io.dcloud.PandoraEntry").communicate()  # 拉起来
        time.sleep(7)
        d(text='登陆').click()
        time.sleep(2)
