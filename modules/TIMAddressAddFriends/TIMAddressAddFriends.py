        ...
        while t < EndIndex + 1:
            ...
            while wait == 1:
                try:
                    ...
                    d.server.adb.cmd("shell",
                                     "am broadcast -a com.zunyun.zime.toast --es msg \"仓库为空，没有取到消息\"").communicate()
            time.sleep(2)
            ...
            if i > 11:
                return
            obj = d(resourceId='com.tencent.tim:id/elv_buddies', className='android.widget.AbsListView').child(
                className='android.widget.RelativeLayout', index=i).child(resourceId='com.tencent.tim:id/text1',
                                                                          index=1)  # 点击第ｉ个人
            if obj.exists:
                obj.click()
                time.sleep(2)
...
if __name__ == "__main__":
    ...
    args = {"repo_material_id": "40", "time_delay": "3", "EndIndex": "8"};  # cate_id是仓库号，length是数量
    o.action(d, z, args)
    #2113