...
class MMCQQAppointFriendsSendText:
    def __init__(self):
        self.repo = Repo()
    ...
    def action(self, d, z,args):
        ...
        while i < add_count:
            ...
            if d(resourceId='com.tencent.mobileqq:id/input',className="android.widget.EditText").exists:
                ...
                for i in range(0,random.randint(1,meg_count)):
...
def getPluginClass():
    return MMCQQAppointFriendsSendText
