    ...
    def action(self, d, z, args):
        ...
        for sc in range(2):
            ...
            if result=='over':
                ...
                # d.press.back( )
                # time.sleep( 1 )
                self.repo.BackupInfo( args["repo_account_id"], 'using', account.split( '@' )[0], '', '' )  # 仓库号,使用中,QQ号,设备号_卡槽号QQNumber
                return
            else:
                # d.press.back()
                # time.sleep(1)
...
if __name__ == "__main__":
    ...
    args = {"repo_material_cateId": "412", "time_delay": "5","size":"实际大小","repo_material_cateId2":"409","selectContent":"主题内容都发","nuberLoop":"循环","addToText":"添加",'train_cate_id':"411",'random_code':"不乱码",'repo_account_id':'413'}
