...
class TIMAddfriendsByNumber:
    ...
    def action(self, d, z,args):
        ...
        while count<add_count:
            ...
            numbers = self.repo.GetNumber( repo_number_cate_id, 120, 1 )    # 取出两小时内没有用过的号码
            # list = numbers
            QQnumber = numbers[0]['number']
            z.heartbeat( )
            time.sleep(1)
...
if __name__ == "__main__":
    ...
    args = {"time_delay":"3","repo_number_cate_id":"119","repo_material_cate_id":"52",'gender':"男","add_count":"1","switch_card":"N"}    #cate_id是仓库号，length是数量
    o.action( d, z, args )
