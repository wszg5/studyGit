...
class MobilqqLogin:
    ...
    def action(self, d, z, args):
        ...
        if slotnum == 0:    #没有空卡槽的话
            ...
            self.repo.BackupInfo(cate_id, 'using', QQnumber, featureCodeInfo, '%s_%s_%s' % (d.server.adb.device_serial(), self.type, slotnum))  # 仓库号,使用中,QQ号,设备号_卡槽号
...
if __name__ == "__main__":
    ...
    args = {"repo_cate_id": "275", "time_limit": "120", "time_limit1": "120", "time_delay": "3"};    #cate_id是仓库号，length是数量
    # z.server.install( )
    o.action(d, z, args)
