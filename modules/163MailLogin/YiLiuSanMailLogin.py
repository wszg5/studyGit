    ...
    def action(self, d,z,args):
        ...
        while i < 200:
            ...
            if 'icmp_seq' and 'bytes from' and 'time' in ping[0]:
                z.toast(u"网络通畅。开始执行：163邮箱登录 无卡槽" )
                break
            z.sleep(2)
        if i > 200:
        ...
        while True:
            try:
                d.server.adb.cmd("shell", "pm clear com.tencent.androidqqmail").communicate()  # 清除163邮箱缓存
...
if __name__ == "__main__":
    ...
    args = {"repo_account_id": "330", "account_time_limit": "15"}
    o.action(d, z, args)
    # d.server.adb.cmd( "shell", "am force-stop com.tencent.androidqqmail" ).wait( )  # 强制停止
