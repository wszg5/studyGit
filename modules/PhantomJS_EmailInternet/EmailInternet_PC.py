...
if __name__ == "__main__":
    ...
    cap["chrome.page.settings.resourceTimeout"] = 1000
    cap["chrome.page.settings.loadImages"] = False
    cap["chrome.page.settings.disk-cache"] = True
    cap["chrome.page.settings.userAgent"] = "Mozilla/5.0(Linux;U;Android2.3.7;en-us;NexusOneBuild/FRF91)AppleWebKit/533.1(KHTML,likeGecko)Version/4.0MobileSafari/533.1"
    cap["chrome.page.customHeaders.User-Agent"] = "Mozilla/5.0(Linux;U;Android2.3.7;en-us;NexusOneBuild/FRF91)AppleWebKit/533.1(KHTML,likeGecko)Version/4.0MobileSafari/533.1"
    driver = webdriver.Chrome(desired_capabilities=cap, executable_path=r"C:\Google\Chrome\Application\chromedriver.exe")
    # driver = webdriver.Chrome(executable_path=r"C:\Google\Chrome\Application\chromedriver.exe")
    driver.get("https://w.mail.qq.com/")
