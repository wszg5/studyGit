...
class QQEmailSendTextAndReceiveMailZ:
    def __init__(self):
...
def getPluginClass():
    return QQEmailSendTextAndReceiveMailZ
...
if __name__ == "__main__":
    ...
    args = {"repo_mail_cateId": "274","account_cateId": "358", "repo_material_cateId": "40", "time_delay": "3","count":"1","bccCount":"1","sendCount":"2","picture":"否","size":"实际大小",
            "repo_material_cateId2":"52","selectContent":"主题内容都发","failCount":"7","nuberLoop":"循环"}
    # Str = d.info  # 获取屏幕大小等信息
    # height = int( Str["displayHeight"] )
    # width = int( Str["displayWidth"] )
